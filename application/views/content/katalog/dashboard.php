<style>
    ...
    .table-striped>tbody>tr:nth-child(2n+1)>th { background-color: #FFFBF5; }
</style>
...
<div class="content-wrapper" style="background-color: #F5F5F5;">
                ...
                <form action="<?= base_url('katalog/updateOnlineShop') ?>" method="post">
                    <div class="modal-body">
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-2 p-2 rounded" 
                            style="background:#fff4f2; border:1px solid #ee4d2d;">
                            ...
                            <div class="custom-control custom-switch mb-0">
                                <input type="checkbox" class="custom-control-input" 
                                    id="switch_shopee" name="shopee" value="1">
                        ...
                        <!-- Tokopedia -->
                        <div class="d-flex align-items-center justify-content-between mb-2 p-2 rounded" 
                            style="background:#f0fff1; border:1px solid #42b549;">
                            <div class="d-flex align-items-center">
                            ...
                            <div class="custom-control custom-switch mb-0">
                                <input type="checkbox" class="custom-control-input" 
                                    id="switch_tokopedia" name="tokopedia" value="1">
                        ...
                        <div class="d-flex align-items-center justify-content-between p-2 rounded" 
                            style="background:#f0f6ff; border:1px solid #6096B4;">
                            <div class="d-flex align-items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24">
                            ...
                            <div class="custom-control custom-switch mb-0">
                                <input type="checkbox" class="custom-control-input" 
                                    id="switch_kiushop" name="kiushop" value="1">
    ...
    <!-- MODAL TOGGLE AKTIF -->
    <div class="modal fade" id="modalToggleAktif" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header" id="modalToggleHeader">
                    <h5 class="modal-title" id="modalToggleTitle">Ubah Status Produk</h5>
                    <button type="button" class="close" data-dismiss="modal"><span>&times;</span></button>
                </div>
                <div class="modal-body">
                    <p>Yakin ingin <strong id="toggle_label_text"></strong> produk 
                    <strong id="toggle_nama_barang"></strong>?</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
                    <button type="button" class="btn btn-primary" id="btn_confirm_toggle">Ya, Ubah</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row mb-3 px-2">
        ...
        <div class="col-6 col-md-3 mb-2">
            <div class="info-box shadow-sm mb-0" style="border-left: 4px solid #28a745;">
                <span class="info-box-icon" style="background-color:#28a745;">
        ...
        <div class="col-6 col-md-3 mb-2">
            <div class="info-box shadow-sm mb-0" style="border-left: 4px solid #dc3545;">
                <span class="info-box-icon" style="background-color:#dc3545;">
        ...
        <div class="col-12">
            <div class="card shadow-sm">
                <div class="card-body py-2">
                    ...
                    <!-- Filter Status Aktif -->
                    <div class="d-flex align-items-center flex-wrap">
                        <label class="mr-2 mb-1"><strong>Status:</strong></label>
                        <div class="btn-group flex-wrap" role="group">
                            <button type="button" class="btn btn-sm btn-outline-secondary btn-filter-aktif active"
                                    data-aktif="">Semua</button>
                            <button type="button" class="btn btn-sm btn-outline-success btn-filter-aktif"
                                    data-aktif="F">
                        ...
                        <div class="card-body" style="background-color: white;">
                            ...
                            <div>
                                <button type="button" class="btn btn-primary mb-3" 
                                        data-toggle="modal" data-target="#tambahbarang">
                            ...
                            <table id="example1" class="table table-bordered table-striped display mt-2" style="width:100%;">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="tcenter" style="background-color:#6096B4; color:white;">Status</th>
